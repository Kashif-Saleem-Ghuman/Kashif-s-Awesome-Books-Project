...
[Awesome Book]( https://kashif-saleem-ghuman.github.io/Kashif-s-Awesome-Books-Project/)
...
- Create a new directory in which you want to clone the repository.

- Open the command prompt/gitbash/vs code terminal and navigate to the created directory.

- On the terminal run this command git clone https://github.com/Kashif-Saleem-Ghuman/Kashif-s-Awesome-Books-Project.git.

- Go to the repository folder using command prompt cd Kashif-s-Awesome-Books-Project.

- Install the linters from: https://github.com/microverseinc/linters-config/tree/master/html-css-js.
...
Feel free to check the [issues page](https://github.com/Kashif-Saleem-Ghuman/Kashif-s-Awesome-Books-Project/issues).
